...
class DialogueBox extends FlxSpriteGroup
{
	...
	var fadeInSpeed:String;
	var fadeInEase:String;
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		cutsceneBG = new FlxSprite(-600, -450).loadGraphic(Paths.image('transition'));
		cutsceneBG.visible = true;
		cutsceneBG.scale.set(500, 500);
		cutsceneBG.updateHitbox;
		add(cutsceneBG);

		cutsceneImage = new FlxSprite(-540, -450);
		cutsceneImage.visible = false;
		cutsceneImage.scale.set(0.55, 0.55);
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'chilly-sleepy':
				hasDialog = true;
				box.frames = Paths.getSparrowAtlas('boxes/dialogueBox-scroll');
				box.animation.addByPrefix('normalOpen', 'Text Box Appear', 24, false);
				box.animation.addByIndices('normal', 'Text Box Appear', [4], "", 24);
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'chilly-sleepy':
				...
				portraitLeft.animation.addByPrefix('enter', 'aergiePortrait', 24, false);
				portraitLeft.scrollFactor.set();
				add(portraitLeft);
				portraitLeft.visible = false;
			...
			case "bg":
				switch(curAnim){
					...
					default:
						...
						cutsceneImage.loadGraphic(Paths.image(dialogueList[0]));
						dialogue.visible = true;
						advanceDialogue();
				}
			case "wait":
			...
			case "box":
				switch(curAnim){
					...
					default:
						box.visible = true;
						box.alpha = 1;
						box.frames = Paths.getSparrowAtlas('boxes/' + curAnim);
						box.animation.addByPrefix('normalOpen', 'Text Box Appear', 24, false);
						box.animation.addByIndices('normal', 'Text Box Appear', [4], "", 24);
						box.animation.play('normalOpen');
						advanceDialogue();
			...
			case "fadeIn":
				switch(curAnim){
					case "sine":
						...
						FlxTween.tween(cutsceneImage, {alpha: 1}, 0.5, {
						ease: FlxEase.sineInOut,
			...
			case "fadeOut":
				switch(curAnim){
					case "sine":
						...
						FlxTween.tween(cutsceneImage, {alpha: 0}, 0.5, {
							ease: FlxEase.sineInOut,
							onComplete: function(twn:FlxTween)
								{
									dialogue.visible = true;
						...
						switch(ease){
							case "sine":
								switch(speed){
									case "slow":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 1}, 2, {
											ease: FlxEase.sineInOut
										});
									case "normal":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 1}, 1.5, {
											ease: FlxEase.sineInOut
										});
									case "fast":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 1}, 1, {
											ease: FlxEase.sineInOut
										});
									case "quick":
										cutsceneImage.visible = true;
									...
									case "swift":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 1}, 0.25, {
											ease: FlxEase.sineInOut
										});
									case "instant":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 1}, 0, {
											ease: FlxEase.sineInOut
										});
									default:
										cutsceneImage.visible = true;
						...
						switch(ease){
							case "sine":
								switch(speed){
									case "slow":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 0}, 2, {
											ease: FlxEase.sineInOut
										});
									case "normal":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 0}, 1.5, {
											ease: FlxEase.sineInOut
										});
									case "fast":
										cutsceneImage.visible = true;
									...
									case "swift":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 0}, 0.25, {
											ease: FlxEase.sineInOut
										});
									case "instant":
										cutsceneImage.visible = true;
										FlxTween.tween(cutsceneImage, {alpha: 0}, 0, {
											ease: FlxEase.sineInOut
										});
									default:
										cutsceneImage.visible = true;
